...
!function (e) {
  ...
  var define, module, exports;return function e(t, r, n) {
    function o(u, a) {
      if (!r[u]) {
        if (!t[u]) {
      ...
      var n = e("../src/store-engine"),
          o = e("../storages/all"),
          i = [e("../plugins/json2")];t.exports = n.createStore(o, i);
        ...
        function f(e) {
          ...
          var r,
              ...
              if (!s) return "null";if (gap += indent, u = [], "[object Array]" === Object.prototype.toString.apply(s)) {
                for (i = s.length, r = 0; r < i; r += 1) u[r] = str(r, s) || "null";return o = 0 === u.length ? "[]" : gap ? "[\n" + gap + u.join(",\n" + gap) + "\n" + a + "]" : "[" + u.join(",") + "]", gap = a, o;
              }if (rep && "object" === ("undefined" == typeof rep ? "undefined" : _typeof(rep))) for (i = rep.length, r = 0; r < i; r += 1) "string" == typeof rep[r] && (n = rep[r], o = str(n, s), o && u.push(quote(n) + (gap ? ": " : ":") + o));else for (n in s) Object.prototype.hasOwnProperty.call(s, n) && (o = str(n, s), o && u.push(quote(n) + (gap ? ": " : ":") + o));return o = 0 === u.length ? "{}" : gap ? "{\n" + gap + u.join(",\n" + gap) + "\n" + a + "}" : "{" + u.join(",") + "}", gap = a, o;}
        }var rx_one = /^[\],:{}\s]*$/,
          ...
          var n;if (gap = "", indent = "", "number" == typeof r) for (n = 0; n < r; n += 1) indent += " ";else "string" == typeof r && (indent = r);if (rep = t, t && "function" != typeof t && ("object" !== ("undefined" == typeof t ? "undefined" : _typeof(t)) || "number" != typeof t.length)) throw new Error("JSON.stringify");return str("", { "": e });
        }), "function" != typeof JSON.parse && (JSON.parse = function (text, reviver) {
          function walk(e, t) {
            var r,
                n,
                o = e[t];if (o && "object" === ("undefined" == typeof o ? "undefined" : _typeof(o))) for (r in o) Object.prototype.hasOwnProperty.call(o, r) && (n = walk(o, r), void 0 !== n ? o[r] = n : delete o[r]);return reviver.call(e, t, o);
      ...
      "use strict";
      function n(e, t) {
        var r = { _seenPlugins: [], _namespacePrefix: "", _namespaceRegexp: null, _legalNamespace: /^[a-zA-Z0-9_\-]+$/, _storage: function () {
            ...
            try {
              var t = "__storejs__test__";e.write(t, t);var r = e.read(t) === t;return e.remove(t), r;
            } catch (n) {
              return !1;
            }
          }, _assignPluginFnProp: function (e, t) {
            var r = this[t];this[t] = function () {
              function t() {
                if (r) {
                  var e = r.apply(o, t.args);return delete t.args, e;
                }
              }var n = Array.prototype.slice.call(arguments, 0),
                  o = this,
                  i = [t].concat(n);return t.args = n, e.apply(o, i);
            };
          }, _serialize: function (e) {
            return JSON.stringify(e);
          }, _deserialize: function (e, t) {
            if (!e) return t;var r = "";try {
              r = JSON.parse(e);
            } catch (n) {
              r = e;
            }return void 0 !== r ? r : t;
          } },
            n = a(r, l);return u(e, function (e) {
          n.addStorage(e);
        }), u(t, function (e) {
          n.addPlugin(e);
        }), n;
          ...
          s = o.isList,
          c = o.isFunction,
          f = o.isObject;t.exports = { createStore: n };var l = { version: "2.0.3", enabled: !1, storage: null, addStorage: function (e) {
          ...
          var t = this;if (s(e)) return void u(e, function (e) {
            ...
            if (this._seenPlugins.push(e), !c(e)) throw new Error("Plugins must be function values that return objects");var n = e.call(this);if (!f(n)) throw new Error("Plugins must return an object of function properties");u(n, function (r, n) {
              if (!c(r)) throw new Error("Bad plugin property: " + n + " from plugin " + e.name + ". Plugins should only return functions.");t._assignPluginFnProp(r, n);
            });
          }
        }, get: function (e, t) {
          var r = this._storage().read(this._namespacePrefix + e);return this._deserialize(r, t);
        }, set: function (e, t) {
          ...
          var t = this;this._storage().each(function (r, n) {
      ...
      (function (e) {
        ...
        function r() {
          ...
          if (Object.create) return function (e, t, r, n) {
            var o = u(arguments, 1);return g.apply(this, [Object.create(e)].concat(o));
          };var e = function () {};return function (t, r, n, o) {
            var i = u(arguments, 1);return e.prototype = t, g.apply(this, [new e()].concat(i));
          };
        }function o() {
          ...
          var r = f(e) ? [] : {};return c(e, function (e, n) {
            return r[n] = t(e, n), !1;
          }), r;
        }function c(e, t) {
          if (f(e)) {
          ...
          return e && "[object Object]" === {}.toString.call(e);
            ...
            d = n(),
            v = o(),
            h = "undefined" != typeof window ? window : e;t.exports = { assign: g, create: d, trim: v, bind: i, slice: u, each: a, map: s, pluck: c, isList: f, isFunction: l, isObject: p, Global: h };
    ...
    }, { "./cookieStorage": 7, "./localStorage": 8, "./memoryStorage": 9, "./oldFF-globalStorage": 10, "./oldIE-userDataStorage": 11, "./sessionStorage": 12 }], 7: [function (e, t, r) {
      "use strict";
      function n(e) {
        ...
        return new RegExp("(?:^|;\\s*)" + escape(e).replace(/[\-\.\+\*]/g, "\\$&") + "\\s*\\=").test(p.cookie);
          ...
          f = c.Global,
          l = c.trim;t.exports = { name: "cookieStorage", read: n, write: i, each: o, remove: u, clearAll: a };var p = f.document;
      ...
      function n(e) {
        ...
        s = {};
      }t.exports = { name: "memoryStorage", read: n, write: o, each: i, remove: u, clearAll: a };var s = {};
    }, {}], 10: [function (e, t, r) {
      "use strict";
      function n(e) {
        return f[e];
        ...
        i(function (e, t) {
          ...
          c = s.Global;t.exports = { name: "oldFF-globalStorage", read: n, write: o, each: i, remove: u, clearAll: a };var f = c.globalStorage;
    }, { "../src/util": 5 }], 11: [function (e, t, r) {
      "use strict";
      function n(e, t) {
        if (!v) {
          var r = s(e);d(function (e) {
        ...
        d(function (t) {
          for (var r = t.XMLDocument.documentElement.attributes, n = r.length - 1; n >= 0; n--) {
            var o = r[n];e(t.getAttribute(o.name), o.name);
          }
        });
      }function u(e) {
        var t = s(e);d(function (e) {
          e.removeAttribute(t), e.save(p);
        });
      }function a() {
        d(function (e) {
          var t = e.XMLDocument.documentElement.attributes;e.load(p);for (var r = t.length - 1; r >= 0; r--) e.removeAttribute(t[r].name);e.save(p);
        });
      }function s(e) {
        return e.replace(/^d/, "___$&").replace(h, "___");
      }function c() {
        if (!g || !g.documentElement || !g.documentElement.addBehavior) return null;var e,
            t,
            r,
            n = "script";try {
          ...
          var n = [].slice.call(arguments, 0);n.unshift(r), e.appendChild(r), r.addBehavior("#default#userData"), r.load(p), t.apply(this, n), e.removeChild(r);
        };
      }var f = e("../src/util"),
          l = f.Global;t.exports = { name: "oldIE-userDataStorage", write: n, read: o, each: i, remove: u, clearAll: a };var p = "storejs",
          g = l.document,
          d = c(),
