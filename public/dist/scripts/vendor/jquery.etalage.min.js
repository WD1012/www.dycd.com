    ...
    var c = a.extend({ align: "left", thumb_image_width: 300, thumb_image_height: 400, source_image_width: 900, source_image_height: 1200, zoom_area_width: 600, zoom_area_height: "justify", zoom_area_distance: 10, zoom_easing: true, click_to_zoom: false, zoom_element: "auto", show_descriptions: true, description_location: "bottom", description_opacity: 0.7, small_thumbs: 3, smallthumb_inactive_opacity: 0.4, smallthumb_hide_single: true, smallthumb_select_on_hover: false, smallthumbs_position: "bottom", magnifier_opacity: 0.5, magnifier_invert: true, show_icon: true, icon_offset: 20, hide_cursor: false, show_hint: true, hint_offset: 15, speed: 600, autoplay: true, autoplay_interval: 6000, keyboard: true, right_to_left: false, click_callback: function () {
      ...
      var aD = a(this);if (aD.is("ul") && aD.children("li").length && aD.find("img.etalage_source_image").length) {
        var aa,
            ...
            W = 0,
            V = 0,
            aC = "hori";if (typeof aN === "undefined" || !aN) {
          aN = "[no id]";
        ...
        }aD.addClass("etalage").show();var v = aD.children("li").addClass("etalage_thumb");v.first().show().addClass("etalage_thumb_active");var p = v.length,
            aG = c.autoplay;if (p < 2) {
          aG = false;
        }if (c.align === "right") {
          ...
          aX += 1;var a0 = a(this),
              ...
              aY = a0.find("a");a0.data("id", aX).addClass("thumb_" + aX);if (!j.length && aZ.length) {
        ...
        });var ar = v.find(".etalage_thumb_image").css({ width: c.thumb_image_width, height: c.thumb_image_height }).show();a.each(ar, function () {
          a(this).data("src", this.src);
        });var aL = a('<li class="etalage_magnifier"><div><img /></div></li>').appendTo(aD),
            Y = aL.children("div"),
            h = Y.children("img");var D = a('<li class="etalage_icon">&nbsp;</li>').appendTo(aD);if (c.show_icon) {
          D.show();
        }var q;if (c.show_hint) {
          q = a('<li class="etalage_hint">&nbsp;</li>').appendTo(aD).show();
        }var I,
            r = c.zoom_element;if (r !== "auto" && r && a(r).length) {
          I = a(r).addClass("etalage_zoom_area").html('<div><img class="etalage_zoom_img" /></div>');
        } else {
          r = "auto";I = a('<li class="etalage_zoom_area"><div><img class="etalage_zoom_img" /></div></li>').appendTo(aD);
        ...
        var aw;if (c.show_descriptions) {
          aw = a('<div class="etalage_description' + (c.right_to_left ? " rtl" : "") + '"></div>').prependTo(I);
            ...
            t,
            x,
            ag = c.small_thumbs;if (p > 1 || !c.smallthumb_hide_single) {
          aM = a('<li class="etalage_small_thumbs"><ul></ul></li>').appendTo(aD);l = aM.children("ul");a.each(ar, function () {
            var i = a(this);O = i.data("src");G = i.parents(".etalage_thumb").data("id");a('<li><img class="etalage_small_thumb" src="' + O + '" /></li>').data("thumb_id", G).appendTo(l);
          ...
          if (ag < 3) {
            ...
            a(this).data("id", j + 1);
          });t = aR.children("img");x = aR.length;if (aC === "vert") {
        ...
        if (p > 1 || !c.smallthumb_hide_single) {
          aB = parseInt(aR.css("borderLeftWidth"), 10) + parseInt(aR.css("borderRightWidth"), 10) + parseInt(t.css("borderLeftWidth"), 10) + parseInt(t.css("borderRightWidth"), 10);N = parseInt(aR.css("marginTop"), 10);au = parseInt(aR.css("paddingLeft"), 10) + parseInt(aR.css("paddingRight"), 10) + parseInt(t.css("marginLeft"), 10) + parseInt(t.css("marginRight"), 10) + parseInt(t.css("paddingLeft"), 10) + parseInt(t.css("paddingRight"), 10);if (aC === "vert") {
            ...
            ad = Math.round((L - (ag - 1) * N) / ag) - (aB + au);aA = Math.round(c.thumb_image_height * ad / c.thumb_image_width);n = ad + aB + au;aE = aA + aB + au;
          }
        }var d = parseInt(I.css("borderTopWidth"), 10),
            ax = parseInt(c.zoom_area_distance),
            H = parseInt(I.css("paddingTop"), 10),
            R,
            aW;if (c.zoom_area_width - d * 2 - H * 2 > c.source_image_width) {
        ...
        }var aT, ap, u, ao;if (c.show_descriptions) {
          aT = parseInt(aw.css("borderLeftWidth"), 10) + parseInt(aw.css("borderRightWidth"), 10);ap = parseInt(aw.css("marginLeft"), 10) + parseInt(aw.css("marginRight"), 10);u = parseInt(aw.css("paddingLeft"), 10) + parseInt(aw.css("paddingRight"), 10);ao = R - aT - ap - u;
        }var aJ;if (e) {
        ...
        if (c.smallthumbs_position === "left") {
          ...
          aO = L + N + n;aD.css({ width: aO, height: M });
        } else {
          aO = L;aD.css({ width: aO, height: M + N + aE });
        }if (c.show_icon) {
          at = { top: M - D.outerHeight(true) - parseInt(c.icon_offset, 10), left: parseInt(c.icon_offset, 10) };if (c.smallthumbs_position === "left") {
            at.left = n + N + parseInt(c.icon_offset, 10);
          }D.css(at);
        }if (c.show_hint) {
          q.css({ margin: 0, top: -F, right: -B });
        }h.css({ margin: 0, padding: 0, width: c.thumb_image_width, height: c.thumb_image_height });Y.css({ margin: 0, padding: 0, width: T, height: P });aL.css({ margin: 0, padding: 0, left: (o - aj) / 2, top: (K - aH) / 2 }).hide();if (c.smallthumbs_position === "left") {
          aL.css({ left: (o - aj) / 2 + n + N });
        }U.css({ width: R, height: aW });if (c.align === "right" && r === "auto") {
          I.css({ left: -(R + d * 2 + H * 2 + ax) });
        } else {
          if (r === "auto") {
            I.css({ left: aO + ax });
          }
        }I.css({ margin: 0 }).css({ opacity: 0 }).hide();if (c.show_descriptions) {
          at = { width: ao, bottom: H, left: H, opacity: c.description_opacity };if (c.description_location === "top") {
            at.top = H;at.bottom = "auto";
          }aw.css(at).hide();
        }if (p > 1 || !c.smallthumb_hide_single) {
          if (aC === "vert") {
            if (c.smallthumbs_position === "left") {
              ...
              aM.css({ left: L + N });
            }aM.css({ top: 0, height: M });l.css({ height: aE * x + x * N });
            t.css({ width: ad, height: aA }).attr("height", aA);aR.css({ margin: 0, marginBottom: N });
          } else {
            aM.css({ top: M + N, width: L });l.css({ width: n * x + x * N });t.css({ width: ad, height: aA }).attr("width", ad);aR.css({ margin: 0, marginRight: N });
          }if (aC === "vert") {
            aI = aE * ag + (ag - 1) * N - M;
          } else {
            aI = n * ag + (ag - 1) * N - L;
            ...
            if (aI < 0) {
              for (aa = 1; aa <= x - 1; aa = aa + (ag - 1)) {
                ...
                for (Z; Z <= -aI; Z += 1) {
                  if (aC === "vert") {
                    aR.eq(aa + Z - 1).css({ marginBottom: N + 1 });l.css({ height: parseInt(l.css("height"), 10) + 1 });
                  } else {
                    aR.eq(aa + Z - 1).css({ marginRight: N + 1 });l.css({ width: parseInt(l.css("width"), 10) + 1 });
                  }
                }
              }
            }
        ...
        if (c.magnifier_invert) {
        ...
        }ay.attr("src", am.attr("src"));if (c.show_descriptions) {
          f = am.attr("title");if (f) {
            aw.html(f).show();
          }
        }var C = function () {
          if (s) {
            clearInterval(s);s = false;
          }
        };var k = function () {
          if (s) {
            C();
          ...
          aL.stop().fadeTo(aV, an);D.stop().animate({ opacity: 0 }, aV);I.stop().show().animate({ opacity: 1 }, aV);if (c.magnifier_invert) {
            av.stop().animate({ opacity: c.magnifier_opacity }, aV);
          }if (aG) {
            C();
          }
        };var aS = function () {
          aL.stop().fadeOut(c.speed);D.stop().animate({ opacity: 1 }, c.speed);I.stop().animate({ opacity: 0 }, c.speed, function () {
            a(this).hide();
          });if (c.magnifier_invert) {
          ...
          }clearTimeout(w);if (aG) {
            k();
          }
        };var g = function (aZ, aX) {
          var j,
              aY,
              i = aD.find(".etalage_smallthumb_active").removeClass("etalage_smallthumb_active");aZ.addClass("etalage_smallthumb_active");aL.stop().hide();I.stop().hide();if (!aX) {
            af = true;i.stop(true, true).animate({ opacity: c.smallthumb_inactive_opacity }, aV);
            ...
            a(this).hide();
          });j = v.filter(".thumb_" + aZ.data("thumb_id")).addClass("etalage_thumb_active").show().stop().css({ opacity: 0 }).animate({ opacity: 1 }, c.speed);av = j.find(".etalage_thumb_image");am = j.find(".etalage_source_image");if (c.magnifier_invert) {
          ...
          if (c.show_descriptions) {
            ...
            C();k();
          }aY = aZ.data("id");if (p >= ag) {
            aY--;
          }ae(aY);
        };var E = function (aY, j, i, aX) {
          a.each(aR, function () {
            var a0 = a(this),
                aZ = { opacity: c.smallthumb_inactive_opacity };if (a0.data("id") === aX.data("id")) {
              aZ.opacity = 1;
            }if (aC === "vert") {
              aZ.top = "-=" + aY;
            } else {
              ...
              if (af) {
                aX.addClass("etalage_smallthumb_active");af = false;
              }
            });
          });g(aX, true);
        };var aU = function () {
          var aY = W - ai,
              ...
              j = -aY / az,
              i = -aX / az;
          ai = ai - j;ah = ah - i;if (aY < 1 && aY > -1) {
            ai = W;
          }if (aX < 1 && aX > -1) {
            ah = V;
          }ay.css({ left: ai, top: ah });if (al) {
          ...
          var i;if (c.magnifier_invert) {
            aD.find(".etalage_thumb_active").mouseleave();
          }if (!c.right_to_left) {
            i = aD.find(".etalage_smallthumb_active").prev();if (!i.length) {
              i = aR.last();
            }
          } else {
          ...
          if (p <= ag) {
            aY = aY - 1;
          }var a2 = aR.eq(aY);if (a2.length && !af) {
            var a1 = aD.find(".etalage_smallthumb_active"),
                aX = a1.data("id") - 1,
                j;if (aX > aY) {
              y = aX - aY;var aZ = aD.find(".etalage_smallthumb_first"),
                  a3 = aZ.data("id");if (aY < a3) {
                j = aX - a3;y = y - j;aZ.click();
              } else {
                g(a2, false);
              }
            } else {
              if (aX < aY) {
                y = aY - aX;var a0 = aD.find(".etalage_smallthumb_last"),
                    i = a0.data("id") - 1;
                if (aY >= i) {
                  j = i - aX - 1;y = y - j;a0.click();
                } else {
                  g(a2, false);
                }
              }
          ...
          if (!c.click_callback(i, aN)) {
            ...
            etalage_click_callback(i, aN);return false;
          }return true;
        };var ae = function (i) {
          ...
          aS();
            ...
            aP = -(c.source_image_height - aW);v.add(aL).add(D).mousemove(function (a1) {
          var j = Math.round(a1.pageX - av.offset().left + aj),
              i = Math.round(a1.pageY - av.offset().top + aH);var a0 = j - ac,
              aZ = i - ab;if (a0 < aj) {
            a0 = aj;
          }if (a0 > o) {
            a0 = o;
            ...
            aZ = K;
          }aL.css({ left: a0, top: aZ });if (c.magnifier_invert) {
            var aY = a0 - aj,
                aX = aZ - aH;h.css({ left: -aY, top: -aX });
          }W = -((a0 - aj) * (1 / (c.thumb_image_width / c.source_image_width)));V = -((aZ - aH) * (1 / (c.thumb_image_height / c.source_image_height)));
          if (W < aQ) {
            W = aQ;
          }if (V < aP) {
            V = aP;
          ...
          aD.delegate(".etalage_smallthumb_first", "click", function () {
            if (!af || y) {
              var a3 = a(this),
                  ...
                  aZ;if (y) {
                aX = y;
              }af = true;for (var aY = 0; aY < aX; aY += 1) {
                a0 = a3.removeClass("etalage_smallthumb_first");a4 = aD.find(".etalage_smallthumb_last").removeClass("etalage_smallthumb_last");if (a3.prev().length) {
                  a1 = a0.prev().addClass("etalage_smallthumb_first");
                  a2 = a4.prev().addClass("etalage_smallthumb_last");aZ = a0;
                } else {
                  a1 = aR.eq(x - ag).addClass("etalage_smallthumb_first");a2 = aR.eq(x - 1).addClass("etalage_smallthumb_last");aZ = a2.prev();
                }if (aC === "vert") {
                  j = a1.position().top;
                } else {
                  j = a1.position().left;
            ...
            if (!af || y) {
              var a3 = a(this),
                ...
                a4 = a3.removeClass("etalage_smallthumb_last");if (a3.next().length) {
                  a1 = a0.next().addClass("etalage_smallthumb_first");a2 = a4.next().addClass("etalage_smallthumb_last");aZ = a4;
                } else {
                  a1 = aR.eq(0).addClass("etalage_smallthumb_first");a2 = aR.eq(ag - 1).addClass("etalage_smallthumb_last");aZ = a1.next();
                }if (aC === "vert") {
                  j = a1.position().top;
                } else {
                  j = a1.position().left;
            ...
            var i = a(this);if (!i.hasClass("etalage_smallthumb_first") && !i.hasClass("etalage_smallthumb_last") && !i.hasClass("etalage_smallthumb_active") && !af) {
              g(i, false);
            }
          ...
          v.css({ "background-image": "none" });I.css({ "background-image": "none" });
          if (al) {
            al = false;ak.remove();
          }
        });if (aG) {
